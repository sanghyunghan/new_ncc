...
class Generator(object):
    def __init__(
        ...
        #image_min_side=600,
        #image_max_side=1024
        image_min_side=1400, #1520 1216 works. 1700 1360 also. 1750 1400 also.
        image_max_side=1750,
    ...
    def random_transform_group_entry(self, image, annotations):
        ...
        if self.transform_generator:
            ...
            ############ CONTRAST/BRIGHTNESS MODIFICATION PART ##############
#             img_PIL = Image.fromarray(np.uint8(image))
            
#             cont_enhancer = ImageEnhance.Contrast(img_PIL)
#             final_img_PIL = cont_enhancer.enhance(random.uniform(0.5, 1.5)) # only modify contrast
            
#             random_number = random.randrange(0,2)
            
#             if random_number == 0:
#                 cont_enhancer = ImageEnhance.Contrast(img_PIL)
#                 cont_modified_img_PIL = cont_enhancer.enhance(random.uniform(0.5, 1.5))
#                 brit_enhancer = ImageEnhance.Brightness(cont_modified_img_PIL)
#                 final_img_PIL = brit_enhancer.enhance(random.uniform(0.8, 1.2))
                
#             elif random_number == 1:
#                 brit_enhancer = ImageEnhance.Brightness(img_PIL)
#                 brit_modified_img_PIL = brit_enhancer.enhance(random.uniform(0.5, 1.5))
#                 cont_enhancer = ImageEnhance.Contrast(brit_modified_img_PIL)
#                 final_img_PIL = cont_enhancer.enhance(random.uniform(0.8, 1.2))
                
#             image = np.array(final_img_PIL)
            ############ CONTRAST/BRIGHTNESS MODIFICATION PART ##############
