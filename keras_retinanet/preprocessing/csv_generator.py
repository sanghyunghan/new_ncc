...
class CSVGenerator(Generator):
    ...
    def load_image(self, image_index, get_image_path=False):
        if get_image_path is True:
            return read_image_bgr(self.image_path(image_index)), self.image_path(image_index)
        else:
