...
# DATA_SIZE = 5518 # include ncc abn & norm data
# DATA_SIZE = 4200 # include ncc abn only
# DATA_SIZE = 4312 # include ncc abn only and INbreast mass data
#DATA_SIZE = 5217 # CBIS-DDSM, ncc abn 1801 & 1805, INbreast mass data
#DATA_SIZE = 7040 # CBIS-DDSM, ncc abn 1801 & 1805, INbreast mass , normal data
#DATA_SIZE = 3000 # CBIS-DDSM, ncc abn 1801 & 1805, INbreast mass , normal data for test
#DATA_SIZE = 7072 # NCC test에 속한 normal 데이터 제외, validation set 600개 제외한 전체(normal 포함) training set

DATA_SIZE = 4617 # NCC test에 속한 abnormal 데이터 포함한 전체 abnormal 데이터만....
#DATA_SIZE = 4376 # NCC test에 속한 abnormal 데이터 제외한 전체 abnormal 데이터만....
#DATA_SIZE = 241 # NCC test에서(440개) annotation 있는것

#DATA_SIZE = 500 # CBIS-DDSM, ncc abn 1801 & 1805, INbreast mass , normal data for test
#LEARNING_RATE = 5e-6

#LEARNING_RATE = 1e-5  #1e-5 #DATA_SIZE =  4376 일때

#LEARNING_RATE = 1e-6  #DATA_SIZE =  4617, resnete50 일때
#LEARNING_RATE = 1e-7  #DATA_SIZE =  4617, resnet101 일때, 제일 잘나옴
LEARNING_RATE = 1e-7  #DATA_SIZE =  4617, resnet152 일때


#LEARNING_RATE = 0.01  #1e-5 #DATA_SIZE =  241일때
...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        if args.dataset_type == 'coco':
            ...
            print("model................................ : {}".format(args.backbone))
            print("evaluation........................ : {}".format(args.evaluation))
            print("lr................................ : {}".format(LEARNING_RATE))
            print('positive, negative overlap....................: {}'.format('0.5, 0.5'))


            evaluation = Evaluate(validation_generator, save_path='/home/huray/workspace/han_work/han_test/results/eval/', tensorboard=tensorboard_callback)
...
def parse_args(args):
    ...
    oid_parser.add_argument('--version',  help='The current dataset version is V3.', default='2018_12')
    ...
    csv_parser.add_argument('--evaluation', help='evaluation.', default=True)
    ...
    parser.add_argument('--steps',           help='Number of steps per epoch.', type=int, default=DATA_SIZE)
...
def main(args=None):
    ...
    training_model.fit_generator(
        ...
        verbose=1,
        callbacks=callbacks,
        initial_epoch=0  ### default initial epoch=0
    )
