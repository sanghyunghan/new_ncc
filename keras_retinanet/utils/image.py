...
def resize_image(img, min_side=1400, max_side=1750):
    ...
    if min_side < 1400 or max_side < 1750:
        print('WRONG TARGET IMAGE SIZE!')
        raise
    if smallest_side < 1400 or max_side < 1750:
        print('WRONG ORIGINAL IMAGE SIDE!')
        raise
