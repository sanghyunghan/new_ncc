...
def test_one_snapshot(DATA_TO_TEST, val_generator, snapshot_path, test_file_df, SCORE_VALUE, SAVE_DETECTION_IMAGE=False):
...
def test_all_snapshots(DATA_TO_TEST, val_generator, snapshot_directory, test_file_df, SCORE_VALUE):
    ...
    for snap in snapshots:
        snapshot_name, acc, correct_detection, num_of_anno, case_with_no_detection = test_one_snapshot(DATA_TO_TEST, val_generator, snap, test_file_df, SCORE_VALUE)
        
        result_string = "epoch:{}, acc:{}, correct_detection:{}, num of anno:{}, cases with no detection:{}\n".format(snapshot_name, acc, correct_detection, num_of_anno, str(len(case_with_no_detection)))
